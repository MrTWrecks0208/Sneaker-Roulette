  ...
  const faqs: FaqItem[] = [
    {
      ...
      question: 'How do I get the best photos for the sneaker images?',
      answer: (
        <div className="space-y-3 text-zinc-300 leading-relaxed text-sm">
          <p>
            We recommend using <strong>Google Images</strong> to search for the shoes. Once you've found a high-resolution image that you like, right-click on the image and select <strong>'Copy Image'</strong> from the menu.
          </p>
          <p>
            In your browser, open a new tab, and go to <a href="https://removal.ai" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline inline-flex items-center gap-1 font-medium">removal.ai <ExternalLink className="w-3 h-3" /></a>. Once on the site, paste the image, then scroll down. Once the edited image appears, click the <strong>Download</strong> button.
          </p>
          <p>
            Then, go to <a href="https://lunapic.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline inline-flex items-center gap-1 font-medium">lunapic.com <ExternalLink className="w-3 h-3" /></a> and click the <strong>'Upload'</strong> button on the homepage. From your File Explorer, select the image you just downloaded. Once the preview loads, hover your pointer over <strong>'Edit'</strong>, then click on <strong>'Autocrop Image'</strong>.
          </p>
          <p>
            Once your cropped image is generated, click <strong>'Download Now'</strong> at the top of the screen. You will upload this file to <strong>Sneaker Roulette</strong>.
          </p>
          <div className="mt-4 p-3 bg-blue-500/10 border border-blue-500/20 rounded-xl flex items-start gap-2 text-xs text-blue-300">
            ...
            <span>Pro-Tip: Clean, transparent PNG background images cropped closely around the sneaker outline will make your card gallery look crisp and professional!</span>
          </div>
        </div>
      ),
    },
    ...
    },
    {
      ...
      question: 'Can I batch import my sneaker collection from a spreadsheet?',
      answer: (
        <p className="text-zinc-300 leading-relaxed text-sm">
          Yes! Click the <strong>Import</strong> button in the top navigation bar. You can upload or drag-and-drop a CSV file containing columns like Name, Brand, Style, Colors, Times Worn, Image URL, and Condition.
        </p>
      ),
    },
  ];
        ...
        <div className="flex items-center justify-between p-5 border-b border-zinc-800 bg-zinc-900/80 sticky top-0 z-10 backdrop-blur-md">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">Guides, image tips, and Sneaker Roulette features</p>
            </div>
          </div>
          <button
            type="button"
